...
AlienManagerUpdate:
    ...
    call CheckAliensLeft                                ; CheckAliensLeft(&scene)
    call AlienManagerUpdateUfo                          ; AlienManagerUpdateUfp(&scene)
    add esp, 4

    call AlienManagerUpdateShooting
    call AlienManagerUpdateMovement
...
AlienManagerUpdateMovement:
    ...
    fwait
    sahf                                                ; Transfer ax codes to status register
    ja .MovementRet                                     ; I can finally compare now
